...
'''
This script has been used perform functional load calculations on the Slovak National Corpus.
...
for line in open('slovak_corpus.txt', 'r'):
...
functional_load(words_tokens,'ľ', 'l')
functional_load(words_tokens,'ľ', 'j')
functional_load(words_tokens, 'ľ', 'ň')
functional_load(words_tokens, 'ľ', 'ď')


functional_load(words_tokens, 'ä', 'e')
functional_load(words_tokens,'ä', 'a')
