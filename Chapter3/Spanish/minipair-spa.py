...
'''
This script is used to retrieve the number of minimal pairs associated to each phoneme for the Spanish CHILDES data.
...
for word in open('spanish_corpus.txt'):
