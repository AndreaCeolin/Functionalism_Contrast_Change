...
f = open('fake-lang-1.txt', 'w')
for _ in range(150):
    f.write(random.choice(list(consonants)) + '.' + random.choice(list(vowels)) + '.' + random.choice(list(consonants)) + '\n')
f.close()

f = open('fake-lang-2.txt', 'w')
for _ in range(500):
    f.write(random.choice(list(consonants)) + '.' + random.choice(list(vowels)) + '.' + random.choice(list(consonants)) + '\n')
f.close()

f = open('fake-lang-3.txt', 'w')
for _ in range(1000):
    f.write(random.choice(list(consonants)) + '.' + random.choice(list(vowels)) + '.' + random.choice(list(consonants)) + '\n')
f.close()
